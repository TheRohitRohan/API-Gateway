...
export class NotificationController {
    ...
    sendEmail = async (request: FastifyRequest<{ Body: any }>, reply: FastifyReply) => {
    ...
    sendSms = async (request: FastifyRequest<{ Body: any }>, reply: FastifyReply) => {
    ...
    sendPush = async (request: FastifyRequest<{ Body: any }>, reply: FastifyReply) => {
