...
export function buildApp(prisma: PrismaClient): FastifyInstance {
    ...
    app.register(swagger, {
        openapi: {
            info: {
                ...
                description: 'Microservices Playground - Payment Service REST API',
                version: '1.0.0',
            },
            servers: [
                {
    ...
    registerHealthRoutes(app, 'payment-service', '1.0.0');
    ...
    app.register(async (instance) => {
        await paymentRoutes(instance, paymentController);
    });
